 ...
 *
 * HTML Structure Tests for src/assignments/list.html
...
beforeAll(() => {
  const html = fs.readFileSync(
    path.resolve(__dirname, "../../src/assignments/list.html"), "utf8"
  );
...
test("[HTML-08] <section id='assignment-list-section'> exists inside <main>", () => {
  expect(
    document.querySelector("main section#assignment-list-section")
  ).not.toBeNull();
});
